import {ktmanDisk,ktmanRunRight,ktmanRunLeft,ktmanStayLeft,ktmanStayRight} from './ktmanAnim.js'
...
class Player {
    ...
    draw() {
        ...
        if(this.character == 'ktman')
        {
            ...
            else if(player.watchRight && !keys.right.pressed && !keys.left.pressed)
            {
        ...
        else if(this.character == 'blender')
        {
            ...
            if(characteristics.shooting == true && characteristics.shootingDirectionRight == true)
            {
            ...
            else if(characteristics.shooting == true && characteristics.shootingDirectionRight == false)
            {
    ...
    update() {
        ...
        if (this.position.y + this.height + this.velocity.y <= canvas.height)this.velocity.y += characteristics.gravity
    }
}
...
//UPDATE//
    ...
    setInterval(()=>{
        if(player.character == 'ktman' && (keys.left.pressed || keys.right.pressed || !player.watchRight))
        {
            player.threeframes++
